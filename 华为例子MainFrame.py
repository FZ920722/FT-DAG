...
if __name__ == "__main__":
    ...
    FADDR, FTable = f"TCDATA.db", "Total"
    os.remove(FADDR)  
    ...
    dag_num = 0
    st = time.time()
    for __gx in NC(__s, _idx, _odx, _jlx, _hlx, _mdx, _mux, _wdx, _wux, _ms=True, _mc=True):
        dag_num += 1
        print(dag_num)
        __exam_pic_Output(__gx, str(dag_num))
        # print(__gx.edges())
    et = time.time()
    print(f"算法生成_{__nnum}----{dag_num}--{et - st:.6f}")
    
    for __nnum in range(0):
        """ 实验1 """
        # __nnum = 32
        # _idx, _odx = 3, 7
        # _jlx, _hlx = 1, 2
        ...
        for __s in NSG(__nnum, (_ldx, _lux ), (_sdx, _sux), (_mdx, _mux), _idx, _odx):
            ...
            # print(f"s:{__s}, n:{__nnum},id:{_idx},od:{_odx},jl:{_jlx},_hl:{_hlx},md:{_mdx},mu:{_mux},wd:{_wdx},wu:{_wux}")
            shape_num += 1
            ...
            for __gx in NC(__s, _idx, _odx, _jlx, _hlx, _mdx, _mux, _wdx, _wux, _ms=True, _mc=True):
                ...
                # print(__gx.edges())
        et = time.time()
        print(f"算法生成_{__nnum}----{shape_num}----{dag_num}--{et - st:.6f}")
        """
...
# [(2, 11), (3, 11), (4, 12), (5, 12), (6, 12), (1, 2), (1, 3), (1, 4), (1, 5), (1, 6), (8, 11), (9, 11), (10, 12), (7, 8), (7, 9), (7, 10), (11, 13), (11, 14), (11, 15), (11, 16), (11, 17), (12, 18), (12, 19), (12, 20), (12, 21), (12, 22), (0, 1), (0, 7)]
# [(2, 11), (3, 12), (4, 12), (5, 12), (1, 2), (1, 3), (1, 4), (1, 5), (7, 11), (8, 11), (9, 11), (10, 12), (6, 7), (6, 8), (6, 9), (6, 10), (11, 13), (11, 14), (11, 15), (11, 16), (11, 17), (12, 18), (12, 19), (12, 20), (12, 21), (12, 22), (0, 1), (0, 6)]
# [(2, 11), (3, 11), (4, 12), (5, 12), (1, 2), (1, 3), (1, 4), (1, 5), (7, 11), (8, 11), (9, 12), (10, 12), (6, 7), (6, 8), (6, 9), (6, 10), (11, 13), (11, 14), (11, 15), (11, 16), (11, 17), (12, 18), (12, 19), (12, 20), (12, 21), (12, 22), (0, 1), (0, 6)]
# [(6, 7), (6, 8), (6, 9), (6, 10), (6, 11), (2, 6), (3, 6), (4, 6), (5, 6), (1, 2), (1, 3), (1, 4), (1, 5), (17, 18), (17, 19), (17, 20), (17, 21), (17, 22), (13, 17), (14, 17), (15, 17), (16, 17), (12, 13), (12, 14), (12, 15), (12, 16), (0, 1), (0, 12)]
